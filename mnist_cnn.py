...
# Load Fashion-MNIST dataset (28x28 grayscale images in 10 classes)
...
print("\nTraining history saved as 'training_history_mnist.png'")
...
plt.tight_layout()
plt.savefig('predictions_mnist.png')
print("Sample predictions saved as 'predictions_mnist.png'")
...
test_idx = 42
predict_image(model, x_test[test_idx], y_test[test_idx])
